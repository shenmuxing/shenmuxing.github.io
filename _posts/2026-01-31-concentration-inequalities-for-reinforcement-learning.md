...
<!-- Not ready yet, some render errors exist -->
...
This result illustrates that the $$L_2$$ bound is tighter than the $$L_1$$ bound by roughly $$\sqrt{d}$$. Geometrically, this stems from the fact that the $$L_2$$ norm is Euclidean distance (straight line), whereas the $$L_1$$ norm is Manhattan distance (grid path). So the the $$L_1$$ bound incurs an additional $$\sqrt{d}$$ factor in the worst case.

...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "post-concentration-inequalities-for-reinforcement-learning",
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/concentration-inequalities-for-reinforcement-learning/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/shenmuxing", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
